			...
			if data.firstname2 ~= '' then
				...
				if data.firstname3 ~= '' then
					...
					if data.firstname4 ~= '' then
            			TriggerClientEvent('chat:addMessage', source, { args = { '^1[IDENTITY] Character 4:', data.firstname4 .. ' ' .. data.lastname4 } })

            			if data.firstname5 ~= '' then
              				TriggerClientEvent('chat:addMessage', source, { args = { '^1[IDENTITY] Character 5:', data.firstname5 .. ' ' .. data.lastname5 } })

              				if data.firstname6 ~= '' then
                 				TriggerClientEvent('chat:addMessage', source, { args = { '^1[IDENTITY] Character 6:', data.firstname6 .. ' ' .. data.lastname6 } })
							end
						end
					end
				end
